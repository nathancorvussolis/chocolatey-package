...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.7.11/corvusskk-2.7.11.exe'
$checksum = 'ECD1BD1335C5881EE4249D4AAECEF7E7405449C1978E21BEAEE31B340C48208A'
$checksumType = 'sha256'
