...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.8.0/corvusskk-2.8.0.exe'
$checksum = '11E301DFAED385E1A8E72C58AAF255FC86C16CFA82A9B0A0BF348402F67D7671'
$checksumType = 'sha256'
