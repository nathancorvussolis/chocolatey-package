...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/3.1.0/corvusskk-3.1.0.exe'
$checksum = 'A80067707072188139451B0F401CF12FD69A980975711B2ACDF2AFB4B9DEF201'
$checksumType = 'sha256'
