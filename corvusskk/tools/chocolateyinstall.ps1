...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.8.2/corvusskk-2.8.2.exe'
$checksum = '4CA86B0D7C8C411114C2AD46B7ACADDE15234AC9CA22A01DB2FB6EE89A257533'
$checksumType = 'sha256'
