...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.5.1/corvusskk-2.5.1.exe'
$checksum = '21736CE2EF497063747F157B112BC5395FA739831015E11E95747C179B012FBB'
$checksumType = 'sha256'
