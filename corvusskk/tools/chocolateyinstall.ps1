...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.7.8/corvusskk-2.7.8.exe'
$checksum = '5B50ECF896352BC498E4A6F6BF8CF1184C01FDD097508D868C035AD2015101D6'
$checksumType = 'sha256'
