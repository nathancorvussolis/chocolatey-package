...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.6.0/corvusskk-2.6.0.exe'
$checksum = '3E56542F683318683F56A71AFB93086ECB45BD8080E73373FF39C08193474D89'
$checksumType = 'sha256'
