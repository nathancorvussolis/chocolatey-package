...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/3.0.1/corvusskk-3.0.1.exe'
$checksum = '38A73FC871C849568D96847C4360A1505C947A3719B07B9406A9CCC8F2E858EE'
$checksumType = 'sha256'
