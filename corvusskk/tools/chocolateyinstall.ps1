...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.7.2/corvusskk-2.7.2.exe'
$checksum = '19EB01DFE6540C39D662289F8627DACA17AE7DD4247310AA09F020D2E65A7F9F'
$checksumType = 'sha256'
