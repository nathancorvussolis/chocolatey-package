...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.7.0/corvusskk-2.7.0.exe'
$checksum = 'BE1A05623232C24E6607B5178A510638689D21BDE504261340D06B5E032FEEA4'
$checksumType = 'sha256'
