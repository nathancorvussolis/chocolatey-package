...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/3.1.1/corvusskk-3.1.1.exe'
$checksum = 'B2B476C00EFF7181E6345EB35EFA9171999BFDC098A7E5F80BADBED9424C779D'
$checksumType = 'sha256'
