...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/3.1.3/corvusskk-3.1.3.exe'
$checksum = '467419DE6AD9406AA84D8DEEC28042B7661207E848FA69E606EEAF27018D9979'
$checksumType = 'sha256'
