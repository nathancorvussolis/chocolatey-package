...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.5.5/corvusskk-2.5.5.exe'
$checksum = '36AAF8A04E7CF240431B01BFC38EE355E928CDF93E0F4F2BE29829D439C7E3BF'
$checksumType = 'sha256'
