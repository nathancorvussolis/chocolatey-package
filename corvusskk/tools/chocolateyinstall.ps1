...
$installerType = 'exe'
$url = 'https://github.com/nathancorvussolis/corvusskk/releases/download/2.8.1/corvusskk-2.8.1.exe'
$checksum = 'EFED1AA13168A229CFD476E07DF8F59FB91C5637FAF91BB2B77D4E7E31257E8A'
$checksumType = 'sha256'
